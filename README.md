...
# 📖 [Cat Painting] <a name="about-project"></a>

> Cat Painting is one of the many challenges you can find as part of the Responsive Web Design Certificate at FreeCodeCamp.org

**[Cat Painting]** is a project designed to apply some intermediate CSS features.
...
- https://cuauh-cabrera.github.io/cute-cat/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/cute-cat.git
```
